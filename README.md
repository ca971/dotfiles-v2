...
[![Maintained](https://img.shields.io/badge/Status-Active-success?style=flat-square)](https://github.com/ca971/dotfiles-v2)
...
curl -fsSL https://raw.githubusercontent.com/ca971/dotfiles-v2/main/install.sh | bash -s -- --profile ai
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/ca971/dotfiles-v2/main/install.sh | bash -s -- --interactive
```
...
```bash
git clone https://github.com/ca971/dotfiles-v2.git ~/.dotfiles
cd ~/.dotfiles
